...
class Main {
    ...
    public static void main(String... args) {
        ...
        System.out.println("is your character human press 1 for yes and 2 for no");
        take_input(sc.nextInt(), "human", database);

        System.out.println("is your character youtuber press 1 for yes and 2 for no");
        take_input(sc.nextInt(), "youtuber", database);

        System.out.println("is your character in a movie press 1 for yes and 2 for no");
        take_input(sc.nextInt(), "movie", database);

        System.out.println("is your character original press 1 for yes and 2 for no");
        take_input(sc.nextInt(), "original", database);

        System.out.println("is your character inventor press 1 for yes and 2 for no");
        take_input(sc.nextInt(), "inventor", database);

        System.out.println("is your character indian press 1 for yes and 2 for no");
